...
export default function Dock() {
  return (
    <nav className="fixed bottom-0 left-0 z-50 w-full bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 shadow-sm flex items-center justify-around px-1 py-2 md:hidden">
      {DOCK_ITEMS.map(item => (
        <NavLink
          key={item.to}
          to={item.to}
