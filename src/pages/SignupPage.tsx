        ...
        <div className="flex items-center mb-6">
          ...
          <div className="flex-1 text-center">
            <h2 className="text-xl font-semibold text-gray-900">
              {role === "kisaan" ? "Kisaan Signup" : "POS Signup"}
            </h2>
          </div>
        </div>
                ...
                <>
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none transition bg-white text-gray-900 resize-none"
                      rows={3}
                      required
                    />
