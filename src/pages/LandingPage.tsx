      ...
      <div className="relative z-10 max-w-4xl w-full mx-auto text-center px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <a href="/kisaan-login" className="group">
            <div className="h-full flex flex-col justify-between bg-black bg-opacity-40 backdrop-blur-sm rounded-xl shadow-lg p-8 transform transition-all duration-300 ease-in-out border border-gray-600 hover:border-green-400 hover:shadow-green-400/30 hover:shadow-2xl hover:-translate-y-2">
              <div>
          ...
          <a href="/pos-login" className="group">
            <div className="h-full flex flex-col justify-between bg-black bg-opacity-40 backdrop-blur-sm rounded-xl shadow-lg p-8 transform transition-all duration-300 ease-in-out border border-gray-600 hover:border-blue-400 hover:shadow-blue-400/30 hover:shadow-2xl hover:-translate-y-2">
              <div>
                <h2 className="text-4xl font-bold text-white mb-3 tracking-wide text-left">
                  POS
                </h2>
